...
import HomeTypeAnimation from "@/components/home-type-animation";
  ...
  return (
    <section className="relative py-20 lg:py-40 container grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
      ...
      <div className="relative">
        <div className="border boder-foreground/20 rounded-md bg-white dark:bg-foreground/5 px-6 pt-4 pb-8 text-sm relative">
          <Button
            variant="outline"
            size="icon"
